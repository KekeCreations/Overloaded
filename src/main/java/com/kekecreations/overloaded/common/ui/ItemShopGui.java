            ...
            case 0, 9 -> {
                uiCommandBuilder.set("#RARITY1.TextSpans",
                        new Message(new FormattedMessage("COMMON", null, null, null, null,
                                "#FFFFF", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE,
                                null, false,  null)));
            ...
            case 1, 2, 3 -> {
                uiCommandBuilder.set("#RARITY1.TextSpans",
                        new Message(new FormattedMessage("UNCOMMON", null, null, null, null,
                                "#41DE28", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE,
                                null, false,  null)));
            ...
            case 7, 8 -> {
                uiCommandBuilder.set("#RARITY1.TextSpans",
                        new Message(new FormattedMessage("RARE", null, null, null, null,
                                "#1E98F7", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE,
                                null, false,  null)));
            ...
            case 14 -> {
                uiCommandBuilder.set("#RARITY1.TextSpans",
                        new Message(new FormattedMessage("EPIC", null, null, null, null,
                                "#8421FC", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE,
                                null, false,  null)));
            ...
            case 23 -> {
                uiCommandBuilder.set("#RARITY5.TextSpans",
                        new Message(new FormattedMessage("LEGENDARY", null, null, null, null,
                                "#CFB30E", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE,
                                null, false,  null)));
                    ...
                    if (goldComponent.getGold() >= goldComponent.getItemCost1()) {
                        ...
                        switch (goldComponent.getItemCost1()) {
                            case 5 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Copper Armour Set"));
                            }
                            case 12 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Iron Armour Set"));
                            }
                            case 15 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Bronze Armour Set"));
                            }
                            case 20 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Ancient Steel Armour Set"));
                            }
                            case 25 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Thorium Armour Set"));
                            }
                            case 30 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Cobalt Armour Set"));
                            }
                            case 40 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Onyxium Armour Set"));
                            }
                            case 45 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Mithril Armour Set"));
                            }
                        }
                    } else {
                        playerRef.sendMessage(Message.raw(playerRef.getUsername() + " NOT ENOUGH GOLD FOR PURCHASE"));
                    }
                }
                    ...
                    if (goldComponent.getGold() >= goldComponent.getItemCost2()) {
                        ...
                        switch (goldComponent.getItemCost2()) {
                            case 50 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Flamethrower"));
                            }
                            case 3 -> {
                                itemStack = new ItemStack("Weapon_Daggers_Copper", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Copper Daggers"));
                            }
                            case 7 -> {
                                itemStack = new ItemStack("Weapon_Longsword_Copper", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Copper Longsword"));
                            }
                            case 8 -> {
                                itemStack = new ItemStack("Weapon_Sword_Copper", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Copper Sword"));
                            }
                            case 9 -> {
                                itemStack = new ItemStack("Weapon_Battleaxe_Copper", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Copper Battleaxe"));
                            }
                            case 10 -> {
                                itemStack = new ItemStack("Weapon_Mace_Copper", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Copper Mace"));
                            }
                            case 4 -> {
                                itemStack = new ItemStack("Weapon_Daggers_Iron", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Iron Daggers"));
                            }
                            case 11 -> {
                                itemStack = new ItemStack("Weapon_Longsword_Iron", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Iron Longsword"));
                            }
                            case 12 -> {
                                itemStack = new ItemStack("Weapon_Sword_Iron", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Iron Sword"));
                            }
                            case 13 -> {
                                itemStack = new ItemStack("Weapon_Battleaxe_Iron", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Iron Battleaxe"));
                            }
                            case 14 -> {
                                itemStack = new ItemStack("Weapon_Mace_Iron", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Iron Mace"));
                            }
                            case 5 -> {
                                itemStack = new ItemStack("Weapon_Daggers_Thorium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Thorium Daggers"));
                            }
                            case 15 -> {
                                itemStack = new ItemStack("Weapon_Longsword_Thorium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Thorium Longsword"));
                            }
                            case 16 -> {
                                itemStack = new ItemStack("Weapon_Sword_Thorium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Thorium Sword"));
                            }
                            case 17 -> {
                                itemStack = new ItemStack("Weapon_Battleaxe_Thorium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Thorium Battleaxe"));
                            }
                            case 18 -> {
                                itemStack = new ItemStack("Weapon_Mace_Thorium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() +  " Bought 1x Thorium Mace"));
                            }
                            case 6 -> {
                                itemStack = new ItemStack("Weapon_Daggers_Onyxium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Onyxium Daggers"));
                            }
                            case 20 -> {
                                itemStack = new ItemStack("Weapon_Longsword_Onyxium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Onyxium Longsword"));
                            }
                            case 21 -> {
                                itemStack = new ItemStack("Weapon_Sword_Onyxium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Onyxium Sword"));
                            }
                            case 22 -> {
                                itemStack = new ItemStack("Weapon_Battleaxe_Onyxium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Onyxium Battleaxe"));
                            }
                            case 23 -> {
                                itemStack = new ItemStack("Weapon_Mace_Onyxium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Onyxium Mace"));
                            }
                            default -> {
                        ...
                        if (remainder != null && !remainder.isEmpty()) {
                            playerRef.sendMessage(Message.raw(playerRef.getUsername() + " NO INVENTORY SPACE"));
                        } else {
                    ...
                    if (goldComponent.getGold() >= goldComponent.getItemCost3()) {
                        ...
                        switch (goldComponent.getItemCost3()) {
                            case 10 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Copper Shield"));
                            }
                            case 15 -> {
                                itemStack = new ItemStack("Weapon_Shield_Iron", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Iron Shield"));
                            }
                            case 20 -> {
                                itemStack = new ItemStack("Weapon_Shield_Thorium", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Thorium Shield"));
                            }
                            case 25 -> {
                                itemStack = new ItemStack("Weapon_Shield_Cobalt", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Cobalt Shield"));
                            }
                            case 5 -> {
                                itemStack = new ItemStack("Broken_Shield", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Broken Shield"));
                            }
                            case 11 -> {
                                itemStack = new ItemStack("King_Shield", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x King Shield"));
                            }
                            case 12 -> {
                                itemStack = new ItemStack("Weapon_Bomb", 3);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 3x Bombs"));
                            }
                            case 16 -> {
                                itemStack = new ItemStack("Weapon_Bomb_Potion_Poison", 3);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 3x Poison Bombs"));
                            }
                            case 13 -> {
                                itemStack = new ItemStack("Overloaded_Iron_Spear", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Iron Spear"));
                            }
                            case 18 -> {
                                itemStack = new ItemStack("Overloaded_Cobalt_Spear", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Cobalt Spear"));
                            }
                            case 35 -> {
                                itemStack = new ItemStack("Overloaded_Flame_Spear", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Flame Spear"));
                            }
                            default -> {
                                itemStack = new ItemStack("Bandage_Crude", 1);
                            }
                ...
                if (BUY4.equals(data.buttonClicked)) {
                    if (goldComponent.getGold() >= goldComponent.getItemCost4()) {
                        ...
                        switch (goldComponent.getItemCost4()) {
                            case 5 -> {
                                itemStack = new ItemStack("Bandage_Crude", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Crude Bandage"));
                            }
                            case 10 -> {
                                itemStack = new ItemStack("Weapon_Deployable_Slowness_Totem", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Slowness Totem"));
                            }
                            case 15 -> {
                                itemStack = new ItemStack("Weapon_Deployable_Healing_Totem", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Healing Totem"));
                            }
                            case 8 -> {
                                itemStack = new ItemStack("Potion_Health", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Health Potion"));
                            }
                            case 22 -> {
                                itemStack = new ItemStack("Hex_Vial", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Hex Vial"));
                            }
                            case 20 -> {
                                itemStack = new ItemStack("Slap_Vial", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Slap Vial"));
                            }
                            case 24 -> {
                                itemStack = new ItemStack("Shimmer_Vial", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Shimmer Vial"));
                            }
                            case 14 -> {
                                itemStack = new ItemStack("Vampire_Fang", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Vampire Fang"));
                            }
                            case 18 -> {
                                itemStack = new ItemStack("Gold_Vampire_Fang", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Gold_Vampire Fang"));
                            }
                            default -> {
                                itemStack = new ItemStack("Bandage_Crude", 1);
                            }
                    ...
                    if (goldComponent.getGold() >= goldComponent.getItemCost5()) {
                        ...
                        switch (goldComponent.getItemCost5()) {
                            case 15 -> {
                                ...
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Anvil Pet"));
                            }
                            case 8 -> {
                                itemStack = new ItemStack("Trash_Can", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Trash Can"));
                            }
                            case 10 -> {
                                itemStack = new ItemStack("Crimson_Dice", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Crimson Dice"));
                            }
                            case 12 -> {
                                itemStack = new ItemStack("Kunai_Pack", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Kunai Pack"));
                            }
                            case 22 -> {
                                itemStack = new ItemStack("Acid_Orb_Pet", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Acid_Orb_Pet"));
                            }
                            case 25 -> {
                                itemStack = new ItemStack("Meteor_Pet", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Meteor Pet"));
                            }
                            case 18 -> {
                                itemStack = new ItemStack("The_Core", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x The Core"));
                            }
                            case 13 -> {
                                itemStack = new ItemStack("Heart_Pet", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Heart Pet"));
                            }
                            case 20 -> {
                                itemStack = new ItemStack("Ice_Ball_Pet", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Ice Ball Pet"));
                            }
                            case 35 -> {
                                itemStack = new ItemStack("Fireball_Pet", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Fireball Pet"));
                            }
                            case 150 -> {
                                itemStack = new ItemStack("Lucky_Dice", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Lucky Dice"));
                            }
                            case 50 -> {
                                itemStack = new ItemStack("Dice", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Dice"));
                            }
                            case 9 -> {
                                itemStack = new ItemStack("Spear_Head_Pet", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Spear Head Pet"));
                            }
                            case 21 -> {
                                itemStack = new ItemStack("War_Ready_Spear_Head_Pet", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x War Ready Spear Head Pet"));
                            }
                            case 23 -> {
                                itemStack = new ItemStack("Gold_Spear_Head_Pet", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Gold Spear Head Pet"));
                            }
                            case 26 -> {
                                itemStack = new ItemStack("Baby_Skeleton", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Baby Skeleton"));
                            }
                            case 27 -> {
                                itemStack = new ItemStack("Baby_Zombie", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Baby Zombie"));
                            }
                            case 28 -> {
                                itemStack = new ItemStack("Baby_Spider", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Baby Spider"));
                            }
                            case 32 -> {
                                itemStack = new ItemStack("Baby_Cold_Zombie", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Baby Cold Zombie"));
                            }
                            case 34 -> {
                                itemStack = new ItemStack("Baby_Burnt_Skeleton", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Baby Burnt Skeleton"));
                            }
                            case 42 -> {
                                itemStack = new ItemStack("Baby_Zombie_Brute", 1);
                                playerRef.sendMessage(Message.raw(playerRef.getUsername() + " Bought 1x Baby Zombie Brute"));
                            }
                            default -> {
                                itemStack = new ItemStack("Bandage_Crude", 1);
                            }
