...
public class OverloadedTopdownCommand extends AbstractTargetPlayerCommand {
    @Nonnull
    ...
    public OverloadedTopdownCommand() {
        super("overloaded_topdown", "server.commands.camera.topdown.desc");
    }
    ...
    protected void execute(@Nonnull CommandContext context, @Nullable Ref<EntityStore> sourceRef, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef playerRef, @Nonnull World world, @Nonnull Store<EntityStore> store) {
        ...
        //Disables mouse input like breaking blocks
