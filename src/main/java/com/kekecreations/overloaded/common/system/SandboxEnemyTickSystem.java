...
public class SandboxEnemyTickSystem extends DelayedEntitySystem<EntityStore> {

    private final ComponentType<EntityStore, RoundComponent> roundStats;


    public SandboxEnemyTickSystem(ComponentType<EntityStore, RoundComponent> roundStats) {
        super(1.0F);
