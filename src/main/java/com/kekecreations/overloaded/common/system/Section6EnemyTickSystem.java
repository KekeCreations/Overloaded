...
public class Section6EnemyTickSystem extends DelayedEntitySystem<EntityStore> {

    private final ComponentType<EntityStore, RoundComponent> roundStats;


    public Section6EnemyTickSystem(ComponentType<EntityStore, RoundComponent> roundStats) {
        super(0.9F);
